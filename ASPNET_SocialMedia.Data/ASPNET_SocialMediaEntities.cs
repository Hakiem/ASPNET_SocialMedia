...
using ASPNET_SocialMedia.Data.Configuration;

namespace ASPNET_SocialMedia.Data.Models
{
    public class ASPNET_SocialMediaEntities : IdentityDbContext<ApplicationUser>
    {

        public ASPNET_SocialMediaEntities()
            : base("ASPNET_SocialMediaEntities")
        {
        }
